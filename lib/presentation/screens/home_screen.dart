              ...
              child: SafeArea(
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          GenreList(
                            genres: movieRepository.allGenres,
                    ...
                    // Nếu đã chọn genre, chỉ hiển thị 1 danh sách phim theo genre
                          ...
                          child: BlocBuilder<MovieBloc, MovieState>(
                            ...
                            builder: (context, state) {
                              if (state is MovieLoading) {
                                ...
                                if (movies.isEmpty) {
                                  return _buildEmptyState(_selectedGenre!.name);
                                }
                                return MovieList(
                                  title: '',
                                  movies: movies,
                                ...
                                return _buildErrorState(_selectedGenre!.name, state.message, () {
                                  _genreBloc.add(LoadMoviesByGenre(_selectedGenre!.id));
                                });
                              }
